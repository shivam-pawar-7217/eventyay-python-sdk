...
setup(
    ...
    description="A modern, type-safe Python client library for the Eventyay API",
    ...
    project_urls={
        ...
        "Changelog": "https://github.com/shivam-pawar-7217/eventyay-python-sdk/blob/main/CHANGELOG.md",
    },
    ...
    keywords="eventyay api sdk client event management async pydantic",
